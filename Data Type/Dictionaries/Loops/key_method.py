...
# You can use the key method to retrieve the value associated with a specific key in a dictionary.
...
#for key in my_dict: # This is also a valid way to access keys in a dictionary. When you iterate over a dictionary, it returns the keys by default.
    ...
    print(f"Value of \033[1;91m'{key.upper()}'\033[0m: \033[1;92m{my_dict[key]}\033[0m")